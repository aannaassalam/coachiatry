...
const TranscriptionItem = ({
  ...
  const prefetchOnMouseEnter = (id: string) => {
    // MUST be prefetchInfiniteQuery — the detail page reads this same key via
    // useInfiniteQuery, so the cached entry has to be an infinite-query shape
    // ({ pages, pageParams }). A plain prefetchQuery here writes a bare object
    // and the detail page then crashes on `data.pages.length`.
